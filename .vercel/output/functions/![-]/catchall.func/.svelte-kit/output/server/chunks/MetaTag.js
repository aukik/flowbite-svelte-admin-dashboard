import { c as create_ssr_component, h as escape, f as add_attribute, l as each, b as spread, e as escape_object, v as validate_component } from "./ssr.js";
...
const MetaTag = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { path = "" } = $$props;
  let { description = "" } = $$props;
  let { title = "" } = $$props;
  let { subtitle = "" } = $$props;
  let imgsrc = `https://open-graph-vercel.vercel.app/api/flowbite-svelte-admin-dashboard?title=${subtitle}`;
  let og_url = `https://flowbite-svelte-admin-dashboard.vercel.app${path}`;
  ...
  return `${validate_component(MetaTags, "MetaTags").$$render(
    $$result,
    {
      ...
      openGraph: {
        ...
        siteName: "Octobrain Admin Dashboard"
      },
      twitter: {
        handle: "@shinokada",
