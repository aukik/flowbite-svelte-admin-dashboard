      ...
      },
      {
        ...
        default: () => {
          return ` <div class="space-y-6 p-0"><form><div class="grid grid-cols-6 gap-6">${validate_component(Label, "Label").$$render(
            ...
            {
              default: () => {
                return `<span data-svelte-h="svelte-12grs2q">Type</span>  <div class="pt-5">${validate_component(Button, "Button").$$render($$result, {}, {}, {
                  default: () => {
                    return `${escape(data?.type === "around octobrain" ? "Around Octobrain" : data?.type === "sponsored" ? "Sponsored" : "Suggested")}${validate_component(ChevronDownOutline, "ChevronDownOutline").$$render(
                      $$result,
                      {
            ...
            {
              default: () => {
                return `<span data-svelte-h="svelte-7ccxmo">Title</span> ${validate_component(Input, "Input").$$render(
                  $$result,
                  {
                    name: "email",
                    type: "email",
            ...
            {
              default: () => {
                return `<span data-svelte-h="svelte-1lu4b0f">Is Highlighted</span>  <div class="pt-5">${validate_component(Button, "Button").$$render($$result, {}, {}, {
                  default: () => {
                    return `${escape(data?.isHighlighted ? "True" : "False")}${validate_component(ChevronDownOutline, "ChevronDownOutline").$$render(
                      $$result,
                      {
                        class: "w-6 h-6 ms-2 text-white dark:text-white"
                      },
            ...
            {
              default: () => {
                return `<span data-svelte-h="svelte-aiw6h6">Link</span> ${validate_component(Input, "Input").$$render(
                  $$result,
                  {
                    name: "student_id",
                    type: "text",
            ...
            {
              default: () => {
                return `<span data-svelte-h="svelte-8j9h3j">Button Text</span> ${validate_component(Input, "Input").$$render(
                  $$result,
                  {
                    name: "buttonText",
                    type: "text",
            ...
            $$result,
            {
              class: "col-span-6 space-y-2 sm:col-span-3 my-8"
            },
            {},
            {
              default: () => {
                return `<span data-svelte-h="svelte-qonxot">Announcement</span> ${validate_component(Textarea, "Textarea").$$render(
                  $$result,
                  {
                    name: "student_id",
                    type: "text",
                    class: "border outline-none",
                    placeholder: "e.g. bonnie@flowbite.com",
                    value: data.data.announcement
                  },
                  {
                    value: ($$value) => {
                      data.data.announcement = $$value;
                      $$settled = false;
                    }
                  },
                  {}
    ...
    $$rendered = `${validate_component(Modal, "Modal").$$render(
      ...
      },
      {
        footer: () => {
          return `<div slot="footer">${validate_component(Button, "Button").$$render($$result, {}, {}, {
            default: () => {
              return `${escape(Object.keys(data).length ? "Save changes" : "Add post")}`;
            }
          })}</div>`;
        },
        default: () => {
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${validate_component(MetaTag, "MetaTag").$$render($$result, { path, description, title, subtitle }, {}, {})} <main class="relative h-full w-full overflow-y-auto bg-white dark:bg-gray-800"><div class="p-4">${validate_component(Breadcrumb, "Breadcrumb").$$render($$result, { class: "mb-5" }, {}, {
      ...
      {
        default: () => {
          return `All AnnouncedFeaturedPosts`;
        }
      }
      ...
      {},
      {
          ...
          return `<div slot="end" class="flex items-center space-x-2">${validate_component(Button, "Button").$$render(
            ...
            {
              default: () => {
                return `${validate_component(PlusOutline, "PlusOutline").$$render($$result, { size: "sm" }, {}, {})}Add a Featured Post`;
              }
            }
          )} </div>`;
        }
      ...
      default: () => {
        return `${validate_component(TableHead, "TableHead").$$render(
          ...
          {
            default: () => {
              return ` ${each(["Title", "Type", "Link", "Announcement", "Button Text", "Actions"], (title2) => {
              ...
              return `${validate_component(TableBodyRow, "TableBodyRow").$$render($$result, { class: "text-base" }, {}, {
                default: () => {
                  return ` ${validate_component(TableBodyCell, "TableBodyCell").$$render($$result, { class: "p-4" }, {}, {
                    default: () => {
                      return `${escape(user?.title || "N/A")}`;
                    }
                  })} ${validate_component(TableBodyCell, "TableBodyCell").$$render($$result, { class: "p-4" }, {}, {
                    default: () => {
                      return `${escape(user?.type || "N/A")}`;
                    }
                  })}   ${validate_component(TableBodyCell, "TableBodyCell").$$render($$result, { class: "p-4" }, {}, {
                    default: () => {
                      return `${escape(user?.data?.link || "N/A")}`;
                    }
                  })} ${validate_component(TableBodyCell, "TableBodyCell").$$render($$result, { class: "p-4" }, {}, {
                    default: () => {
                      return `${escape(user?.data?.announcement || "N/A")}`;
                    }
                  })} ${validate_component(TableBodyCell, "TableBodyCell").$$render($$result, { class: "p-4" }, {}, {
                    default: () => {
                      return `${escape(user?.data?.buttonText || "N/A")}`;
                    }
