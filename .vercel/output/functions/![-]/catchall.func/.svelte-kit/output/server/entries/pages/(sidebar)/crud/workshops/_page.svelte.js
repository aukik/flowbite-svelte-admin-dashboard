      ...
      },
      {
        ...
        default: () => {
          return ` <div class="space-y-6 p-0"><form><div class="grid grid-cols-6 gap-6">${validate_component(Label, "Label").$$render(
            ...
            {
              default: () => {
                return `<span data-svelte-h="svelte-sq2yvi">Duration</span> ${validate_component(Input, "Input").$$render(
                  $$result,
                  {
                    name: "student_id",
                    type: "text",
            ...
            {
              default: () => {
                return `<span data-svelte-h="svelte-cetw0b">workshop Type</span>  <div class="pt-5">${validate_component(Button, "Button").$$render($$result, {}, {}, {
                  default: () => {
                    return `${escape(data.workshop_type)}${validate_component(ChevronDownOutline, "ChevronDownOutline").$$render(
                      $$result,
                      {
                        class: "w-6 h-6 ms-2 text-white dark:text-white"
                      },
            ...
            {
              default: () => {
                return `<span data-svelte-h="svelte-zjg167">Certificate</span>  <div class="pt-5">${validate_component(Button, "Button").$$render($$result, {}, {}, {
                  default: () => {
                    return `${escape(data.certificate)}${validate_component(ChevronDownOutline, "ChevronDownOutline").$$render(
                      $$result,
                      {
                        class: "w-6 h-6 ms-2 text-white dark:text-white"
                      },
            ...
            {
              default: () => {
                return `<span data-svelte-h="svelte-1ezjg89">Course Outline</span> ${validate_component(Input, "Input").$$render(
                  $$result,
                  {
                    name: "student_id",
                    type: "text",
                    class: "border outline-none",
                    placeholder: "e.g. bonnie@flowbite.com",
                    value: data.course_outline
                  },
                  {
                    value: ($$value) => {
                      data.course_outline = $$value;
                      $$settled = false;
                    }
                  },
                  {}
            ...
            {
              default: () => {
                return `<span data-svelte-h="svelte-r7e8oa">Wokrshop For</span> ${validate_component(Input, "Input").$$render(
                  $$result,
                  {
                    name: "student_id",
                    type: "text",
                    class: "border outline-none",
                    placeholder: "e.g. bonnie@flowbite.com",
                    value: data.workshop_for
                  },
                  {
                    value: ($$value) => {
                      data.workshop_for = $$value;
                      $$settled = false;
                    }
                  },
                  {}
            ...
            {
              default: () => {
                return `<span data-svelte-h="svelte-1unhq3m">Progress Limit</span> ${validate_component(Input, "Input").$$render(
                  $$result,
                  {
                    name: "student_id",
                    type: "text",
                    class: "border outline-none",
                    placeholder: "e.g. bonnie@flowbite.com",
                    value: data.course_total_progress_limit
                  },
                  {
                    value: ($$value) => {
                      data.course_total_progress_limit = $$value;
                      $$settled = false;
                    }
                  },
                  {}
            ...
            {
              default: () => {
                return `<span data-svelte-h="svelte-eq8vxe">What Students will Learn</span> ${validate_component(Input, "Input").$$render(
                  $$result,
                  {
                    name: "student_id",
                    type: "text",
                  ...
                  {
                    value: ($$value) => {
                      data.what_you_will_learn = $$value;
                      $$settled = false;
                    }
                  },
                  {}
            ...
            {
              default: () => {
                return `<span data-svelte-h="svelte-tc5esh">Content</span> ${validate_component(Input, "Input").$$render(
                  $$result,
                  {
                    name: "student_id",
                    type: "text",
                    class: "border outline-none",
                    placeholder: "e.g. bonnie@flowbite.com",
                    value: data.course_content
                  },
                  {
                    value: ($$value) => {
                      data.course_content = $$value;
                      $$settled = false;
                    }
                  },
                  {}
    ...
    $$rendered = `${validate_component(Modal, "Modal").$$render(
      ...
      },
      {
        footer: () => {
          return `<div slot="footer">${validate_component(Button, "Button").$$render($$result, {}, {}, {
            default: () => {
              return `${escape(Object.keys(data).length ? "Save all" : "Add Workshop")}`;
            }
          })}</div>`;
        },
        default: () => {
          return ` <div class="space-y-6 p-0"><form><div class="grid grid-cols-6 gap-6">${validate_component(Label, "Label").$$render(
            ...
            {
              default: () => {
                return `<span data-svelte-h="svelte-qm6mej">Workshop Type</span>  <div class="pt-5">${validate_component(Button, "Button").$$render($$result, {}, {}, {
                  default: () => {
                    return `${escape(workshop_type_label)}${validate_component(ChevronDownOutline, "ChevronDownOutline").$$render(
                      $$result,
                      {
                        class: "w-6 h-6 ms-2 text-white dark:text-white"
                      },
            ...
            {},
            {
              default: () => {
                return `<span data-svelte-h="svelte-zjg167">Certificate</span>  <div class="pt-5">${validate_component(Button, "Button").$$render($$result, {}, {}, {
                  default: () => {
                    return `${escape(is_certificate_label)}${validate_component(ChevronDownOutline, "ChevronDownOutline").$$render(
                      $$result,
                      {
                        class: "w-6 h-6 ms-2 text-white dark:text-white"
                      },
      ...
      },
      {
        default: () => {
          return `${validate_component(ExclamationCircleOutline, "ExclamationCircleOutline").$$render(
            ...
            {},
            {}
          )} <h3 class="mb-6 text-center text-lg text-gray-500 dark:text-gray-400" data-svelte-h="svelte-12kjfie">Are you sure you want to delete this Workshop?</h3> <div class="flex items-center justify-center">${validate_component(Button, "Button").$$render($$result, { color: "red", class: "mr-2" }, {}, {
            default: () => {
              return `Yes, I&#39;m sure`;
            }
    ...
    $$rendered = `${validate_component(MetaTag, "MetaTag").$$render($$result, { path, description, title, subtitle }, {}, {})} <main class="relative h-full w-full overflow-y-auto bg-white dark:bg-gray-800"><div class="p-4">${validate_component(Breadcrumb, "Breadcrumb").$$render($$result, { class: "mb-5" }, {}, {
      ...
      {},
      {
          ...
          return `<div slot="end" class="flex items-center space-x-2">${validate_component(Button, "Button").$$render(
            ...
            {
              default: () => {
                return `${validate_component(PlusOutline, "PlusOutline").$$render($$result, { size: "sm" }, {}, {})}Add a Workshop`;
              }
            }
          )} </div>`;
        }
              ...
              return `${validate_component(TableBodyRow, "TableBodyRow").$$render($$result, { class: "text-base" }, {}, {
                default: () => {
                  return ` ${validate_component(TableBodyCell, "TableBodyCell").$$render($$result, { class: "p-4" }, {}, {
                    ...
                    default: () => {
                      return `${escape(user?.activityType || "N/A")}`;
                    }
                  })} ${validate_component(TableBodyCell, "TableBodyCell").$$render($$result, { class: "p-4" }, {}, {
                    default: () => {
                      return `${escape(user?._count.studentWorkshopJoinRequest)}`;
                    }
                  })} ${validate_component(TableBodyCell, "TableBodyCell").$$render($$result, { class: "p-4" }, {}, {
                    default: () => {
                      return `${escape(user?._count.course_student_bridge)}`;
                    }
                    ...
                    default: () => {
                      return `${validate_component(Button, "Button").$$render($$result, { size: "sm", class: "gap-2 px-3" }, {}, {
                        default: () => {
                          return `${validate_component(PlusOutline, "PlusOutline").$$render($$result, { size: "sm" }, {}, {})} Certificate
					`;
                        }
                      })} ${validate_component(Button, "Button").$$render($$result, { size: "sm", class: "gap-2 px-3" }, {}, {
                        default: () => {
                          return `${validate_component(PlusOutline, "PlusOutline").$$render($$result, { size: "sm" }, {}, {})} Payments
					`;
                        }
                      })} ${validate_component(Button, "Button").$$render($$result, { size: "sm", class: "gap-2 px-3" }, {}, {
                        default: () => {
