import { c as create_ssr_component, v as validate_component, h as escape, s as subscribe, l as each } from "../../../../../chunks/ssr.js";
      ...
      },
      {
        footer: () => {
          return `<div slot="footer">${validate_component(Button, "Button").$$render($$result, { disabled: buttonDisabled }, {}, {
            default: () => {
              return `${escape("Make Payment")}`;
            }
          })}</div>`;
        },
        default: () => {
          return ` <div class="space-y-6 p-0"><form><div class="flex flex-col">${validate_component(Label, "Label").$$render($$result, { class: "col-span-6 space-y-2 my-4" }, {}, {
            default: () => {
              return `<span data-svelte-h="svelte-1c6n72o">Payer Account (PhoneNumber)</span> ${validate_component(Input, "Input").$$render(
                $$result,
                {
                  type: "number",
                  name: "payerAccount",
          ...
          })} ${validate_component(Label, "Label").$$render($$result, { class: "col-span-6 space-y-2 my-4" }, {}, {
            default: () => {
            ...
            default: () => {
              return `<span data-svelte-h="svelte-1997xk9">Payment ID</span> ${validate_component(Input, "Input").$$render(
                $$result,
                {
                  type: "text",
                  name: "paymentId",
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${validate_component(MetaTag, "MetaTag").$$render(
      ...
      {
        path: "/crud/users",
        description: "CRUD users example - Octobrain Admin Dashboard",
        title: "Octobrain Admin Dashboard - CRUD Users",
        subtitle: "CRUD Users"
      },
      {},
      {}
    )} <main class="relative h-full w-full overflow-y-auto bg-white dark:bg-gray-800"><div class="p-4">${validate_component(Breadcrumb, "Breadcrumb").$$render($$result, { class: "mb-5" }, {}, {
      default: () => {
      ...
      {
        default: () => {
          return `Paid Students under ${escape(workshopName)} Workshop`;
        }
      }
              ...
              return `${validate_component(TableBodyRow, "TableBodyRow").$$render($$result, { class: "text-base" }, {}, {
                default: () => {
                  return `${validate_component(TableBodyCell, "TableBodyCell").$$render(
                    ...
                    default: () => {
                      return `${escape(user?.payerAccount || "N/A")}`;
                    }
                    ...
                    {
                      default: () => {
                        return `<div class="text-sm font-normal text-gray-500 dark:text-gray-400"><div class="text-base font-semibold text-gray-900 dark:text-white">${escape(user?.trxID || "N/A")}</div> <div class="text-sm font-normal text-gray-500 dark:text-gray-400">${escape(user?.date || "N/A")}</div></div> `;
                      }
                    }
                  )} ${validate_component(TableBodyCell, "TableBodyCell").$$render($$result, { class: "p-4" }, {}, {
                    default: () => {
                      return `${escape(user?.paymentComplete ? "True" : "False")}`;
                    }
                    ...
                    default: () => {
                      return `${validate_component(Button, "Button").$$render($$result, { size: "sm", class: "gap-2 px-3" }, {}, {
                        default: () => {
                          return `${validate_component(EditOutline, "EditOutline").$$render($$result, { size: "sm" }, {}, {})} Make Payment
						`;
                        }
                      })} `;
                    }
