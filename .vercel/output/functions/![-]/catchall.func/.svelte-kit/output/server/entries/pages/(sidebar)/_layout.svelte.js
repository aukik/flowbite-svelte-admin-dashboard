import { c as create_ssr_component, a as compute_rest_props, k as setContext, b as spread, e as escape_object, d as escape_attribute_value, g as getContext, f as add_attribute, h as escape, i as compute_slots, s as subscribe, v as validate_component, l as each, m as missing_component } from "../../../chunks/ssr.js";
/* empty css                  */
import { N as Navbar_1 } from "../../../chunks/Navbar.js";
import { s as svelte } from "../../../chunks/ssr2.js";
...
const AngleDownOutline = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${withEvents ? `<svg${spread(
    ...
    {}
  )}>${title.id && title.title ? `<title${add_attribute("id", title.id, 0)}>${escape(title.title)}</title>` : ``}${desc.id && desc.desc ? `<desc${add_attribute("id", desc.id, 0)}>${escape(desc.desc)}</desc>` : ``}<path stroke="currentColor"${add_attribute("stroke-linecap", strokeLinecap, 0)}${add_attribute("stroke-linejoin", strokeLinejoin, 0)}${add_attribute("stroke-width", strokeWidth, 0)} d="m19 9-7 7-7-7"></path></svg>` : `<svg${spread(
    [
      { xmlns: "http://www.w3.org/2000/svg" },
      { fill: "none" },
      escape_object($$restProps),
...
const AngleUpOutline = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${withEvents ? `<svg${spread(
    ...
    {}
  )}>${title.id && title.title ? `<title${add_attribute("id", title.id, 0)}>${escape(title.title)}</title>` : ``}${desc.id && desc.desc ? `<desc${add_attribute("id", desc.id, 0)}>${escape(desc.desc)}</desc>` : ``}<path stroke="currentColor"${add_attribute("stroke-linecap", strokeLinecap, 0)}${add_attribute("stroke-linejoin", strokeLinejoin, 0)}${add_attribute("stroke-width", strokeWidth, 0)} d="m5 15 7-7 7 7"></path></svg>` : `<svg${spread(
    [
      { xmlns: "http://www.w3.org/2000/svg" },
      { fill: "none" },
      escape_object($$restProps),
...
const BuildingOutline = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${withEvents ? `<svg${spread(
    ...
    {}
  )}>${title.id && title.title ? `<title${add_attribute("id", title.id, 0)}>${escape(title.title)}</title>` : ``}${desc.id && desc.desc ? `<desc${add_attribute("id", desc.id, 0)}>${escape(desc.desc)}</desc>` : ``}<path stroke="currentColor"${add_attribute("stroke-linecap", strokeLinecap, 0)}${add_attribute("stroke-linejoin", strokeLinejoin, 0)}${add_attribute("stroke-width", strokeWidth, 0)} d="M6 4h12M6 4v16M6 4H5m13 0v16m0-16h1m-1 16H6m12 0h1M6 20H5M9 7h1v1H9V7Zm5 0h1v1h-1V7Zm-5 4h1v1H9v-1Zm5 0h1v1h-1v-1Zm-3 4h2a1 1 0 0 1 1 1v4h-4v-4a1 1 0 0 1 1-1Z"></path></svg>` : `<svg${spread(
    [
      { xmlns: "http://www.w3.org/2000/svg" },
      { fill: "none" },
      escape_object($$restProps),
...
const FileChartBarSolid = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${withEvents ? `<svg${spread(
    ...
    {}
  )}>${title.id && title.title ? `<title${add_attribute("id", title.id, 0)}>${escape(title.title)}</title>` : ``}${desc.id && desc.desc ? `<desc${add_attribute("id", desc.id, 0)}>${escape(desc.desc)}</desc>` : ``}<path fill-rule="evenodd" d="M9 7V2.221a2 2 0 0 0-.5.365L4.586 6.5a2 2 0 0 0-.365.5H9Zm2 0V2h7a2 2 0 0 1 2 2v16a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V9h5a2 2 0 0 0 2-2Zm-1 9a1 1 0 1 0-2 0v2a1 1 0 1 0 2 0v-2Zm2-5a1 1 0 0 1 1 1v6a1 1 0 1 1-2 0v-6a1 1 0 0 1 1-1Zm4 4a1 1 0 1 0-2 0v3a1 1 0 1 0 2 0v-3Z" clip-rule="evenodd"></path></svg>` : `<svg${spread(
    [
      { xmlns: "http://www.w3.org/2000/svg" },
      { fill: escape_attribute_value(color) },
      escape_object($$restProps),
...
const HomeOutline = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${withEvents ? `<svg${spread(
    ...
    {}
  )}>${title.id && title.title ? `<title${add_attribute("id", title.id, 0)}>${escape(title.title)}</title>` : ``}${desc.id && desc.desc ? `<desc${add_attribute("id", desc.id, 0)}>${escape(desc.desc)}</desc>` : ``}<path stroke="currentColor"${add_attribute("stroke-linecap", strokeLinecap, 0)}${add_attribute("stroke-linejoin", strokeLinejoin, 0)}${add_attribute("stroke-width", strokeWidth, 0)} d="m4 12 8-8 8 8M6 10.5V19a1 1 0 0 0 1 1h3v-3a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3h3a1 1 0 0 0 1-1v-8.5"></path></svg>` : `<svg${spread(
    [
      { xmlns: "http://www.w3.org/2000/svg" },
      { fill: "none" },
      escape_object($$restProps),
    ...
    {}
  )}>${title.id && title.title ? `<title${add_attribute("id", title.id, 0)}>${escape(title.title)}</title>` : ``}${desc.id && desc.desc ? `<desc${add_attribute("id", desc.id, 0)}>${escape(desc.desc)}</desc>` : ``}<path stroke="currentColor"${add_attribute("stroke-linecap", strokeLinecap, 0)}${add_attribute("stroke-linejoin", strokeLinejoin, 0)}${add_attribute("stroke-width", strokeWidth, 0)} d="m4 12 8-8 8 8M6 10.5V19a1 1 0 0 0 1 1h3v-3a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3h3a1 1 0 0 0 1-1v-8.5"></path></svg>`} `;
});
const UserSolid = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${withEvents ? `<svg${spread(
    ...
    {}
  )}>${title.id && title.title ? `<title${add_attribute("id", title.id, 0)}>${escape(title.title)}</title>` : ``}${desc.id && desc.desc ? `<desc${add_attribute("id", desc.id, 0)}>${escape(desc.desc)}</desc>` : ``}<path fill-rule="evenodd" d="M12 4a4 4 0 1 0 0 8 4 4 0 0 0 0-8Zm-2 9a4 4 0 0 0-4 4v1a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2v-1a4 4 0 0 0-4-4h-4Z" clip-rule="evenodd"></path></svg>` : `<svg${spread(
    [
      { xmlns: "http://www.w3.org/2000/svg" },
      { fill: escape_attribute_value(color) },
      escape_object($$restProps),
    ...
    {}
  )}>${title.id && title.title ? `<title${add_attribute("id", title.id, 0)}>${escape(title.title)}</title>` : ``}${desc.id && desc.desc ? `<desc${add_attribute("id", desc.id, 0)}>${escape(desc.desc)}</desc>` : ``}<path fill-rule="evenodd" d="M12 4a4 4 0 1 0 0 8 4 4 0 0 0 0-8Zm-2 9a4 4 0 0 0-4 4v1a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2v-1a4 4 0 0 0-4-4h-4Z" clip-rule="evenodd"></path></svg>`} `;
});
            ...
            {},
            {
              default: () => {
                return `<nav class="divide-y divide-gray-200 dark:divide-gray-700">${validate_component(SidebarGroup, "SidebarGroup").$$render($$result, { ulClass: groupClass, class: "mb-3" }, {}, {
                  default: () => {
                    return `${each(posts, ({ name, icon, children, href }) => {
                      return `${children ? `${validate_component(SidebarDropdownWrapper, "SidebarDropdownWrapper").$$render(
                        $$result,
                        {
                          label: name,
                          class: "pr-3",
                          isOpen: dropdowns[name]
                        },
                        {
                          isOpen: ($$value) => {
                        ...
                        },
                        {
                          ...
                          arrowup: () => {
                            return `${validate_component(AngleUpOutline, "AngleUpOutline").$$render(
                              $$result,
                              {
                                slot: "arrowup",
                                strokeWidth: "3.3",
                          ...
                          arrowdown: () => {
                            return `${validate_component(AngleDownOutline, "AngleDownOutline").$$render(
                              $$result,
                              {
                                slot: "arrowdown",
                                strokeWidth: "3.3",
                          ...
                          default: () => {
                            return `${each(Object.entries(children), ([title, href2]) => {
                              return `${validate_component(SidebarItem, "SidebarItem").$$render(
                                $$result,
                                {
                                  ...
                                  spanClass: "ml-9",
                                  class: itemClass,
                                  active: activeMainSidebar === href2
                                },
                                {},
                                {}
                              )}`;
                ...
                })} ${validate_component(SidebarGroup, "SidebarGroup").$$render($$result, { ulClass: groupClass }, {}, {
                  default: () => {
                    return `${each(links, ({ label, href, icon }) => {
                      return `${validate_component(SidebarItem, "SidebarItem").$$render(
                        $$result,
                        {
                          label,
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    $$settled = true;
    $$result.head = previous_head;
    $$rendered = `<header class="sticky top-0 z-40 mx-auto w-full flex-none border-b border-gray-200 bg-white dark:border-gray-600 dark:bg-gray-800">${validate_component(Navbar_1, "Navbar").$$render(
      $$result,
      { drawerHidden },
      {
        drawerHidden: ($$value) => {
      ...
      {}
    )}</header> <div class="overflow-hidden lg:flex">${validate_component(Sidebar_1, "Sidebar").$$render(
      $$result,
      { drawerHidden },
      {
        drawerHidden: ($$value) => {
      ...
      {}
    )} <div class="relative h-full w-full overflow-y-auto lg:ml-64">${slots.default ? slots.default({}) : ``} </div></div>`;
  } while (!$$settled);
  return $$rendered;
});
export {
