...
const EditAvatar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
...
const AddAvatar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { open = false } = $$props;
  let { data = {} } = $$props;
  if ($$props.open === void 0 && $$bindings.open && open !== void 0)
    $$bindings.open(open);
    ...
    $$rendered = `${validate_component(Modal, "Modal").$$render(
      ...
      },
      {
        footer: () => {
          return `<div slot="footer">${validate_component(Button, "Button").$$render($$result, {}, {}, {
            default: () => {
              return `${escape(Object.keys(data).length ? "Save" : "Add avatar")}`;
            }
          })}</div>`;
        },
        default: () => {
      ...
      },
      {
        default: () => {
          return `${validate_component(ExclamationCircleOutline, "ExclamationCircleOutline").$$render(
            ...
            {},
            {}
          )} <h3 class="mb-6 text-center text-lg text-gray-500 dark:text-gray-400" data-svelte-h="svelte-kwrivy">Are you sure you want to delete this Avatar?</h3> <div class="flex items-center justify-center">${validate_component(Button, "Button").$$render($$result, { color: "red", class: "mr-2" }, {}, {
            default: () => {
              return `Yes, I&#39;m sure`;
            }
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${validate_component(MetaTag, "MetaTag").$$render($$result, { path, description, title, subtitle }, {}, {})} <main class="relative h-full w-full overflow-y-auto bg-white dark:bg-gray-800"><div class="p-4">${validate_component(Breadcrumb, "Breadcrumb").$$render($$result, { class: "mb-5" }, {}, {
      default: () => {
        return `${validate_component(BreadcrumbItem, "BreadcrumbItem").$$render($$result, { home: true, href: "/dashboard" }, {}, {
          default: () => {
            return `Home`;
          }
        })} ${validate_component(BreadcrumbItem, "BreadcrumbItem").$$render($$result, { href: "/crud/avatar" }, {}, {
          default: () => {
            return `Avatar`;
          }
        })}`;
      ...
      {},
      {
          ...
          return `<div slot="end" class="flex items-center space-x-2">${validate_component(Button, "Button").$$render(
            ...
            {
              default: () => {
                return `${validate_component(PlusOutline, "PlusOutline").$$render($$result, { size: "sm" }, {}, {})}Add Avatar`;
              }
            }
          )} </div>`;
        }
      ...
      default: () => {
        return `${validate_component(TableHead, "TableHead").$$render(
          ...
          {
            default: () => {
              return ` ${each(["Name", "Image", "Actions"], (title2) => {
              ...
              return `${validate_component(TableBodyRow, "TableBodyRow").$$render($$result, { class: "text-base" }, {}, {
                default: () => {
                  return ` ${validate_component(TableBodyCell, "TableBodyCell").$$render(
                    ...
                    {
                      default: () => {
                        return `<div class="text-sm font-normal text-gray-500 dark:text-gray-400"><div class="text-base font-semibold text-gray-900 dark:text-white">${escape(user?.name)}</div></div> `;
                      }
                    }
                  )} ${validate_component(TableBodyCell, "TableBodyCell").$$render($$result, { class: "p-4" }, {}, {
                    default: () => {
                      return `<img width="40px"${add_attribute("src", user?.imageUrl, 0)}${add_attribute("alt", "avatar-" + user?.imagename, 0)} class="text-sm font-normal text-gray-500 dark:text-gray-400"> `;
                    }
    ...
    })}</main>  ${validate_component(EditAvatar, "User").$$render(
      $$result,
      ...
      {}
    )} ${validate_component(AddAvatar, "Adduser").$$render(
      $$result,
