      ...
      },
      {
        ...
        default: () => {
          return ` <div class="space-y-6 p-0"><form><div class="grid grid-cols-6 gap-6">${validate_component(Label, "Label").$$render(
            ...
            {
              default: () => {
                return `<span data-svelte-h="svelte-oqyrlc">Student Medium</span>  <div class="pt-5">${validate_component(Button, "Button").$$render($$result, {}, {}, {
                  default: () => {
                    return `${escape(data.student_medium_of_education)}${validate_component(ChevronDownOutline, "ChevronDownOutline").$$render(
                      $$result,
                      {
            ...
            {
              default: () => {
                return `<span data-svelte-h="svelte-1evhwxq">Student ID</span> ${validate_component(Input, "Input").$$render(
                  $$result,
                  {
                    name: "student id",
                    type: "text",
            ...
            {
              default: () => {
                return `<span data-svelte-h="svelte-6yvds6">Verification Badge</span>  <span></span> <div class="pt-5">${validate_component(Button, "Button").$$render($$result, {}, {}, {
                  default: () => {
                    return `${escape(data.verificationBadge)}${validate_component(ChevronDownOutline, "ChevronDownOutline").$$render(
                      $$result,
                      {
                        class: "w-6 h-6 ms-2 text-white dark:text-white"
                      },
            ...
            {
              default: () => {
                return `<span data-svelte-h="svelte-1wbahcu">Address</span> ${validate_component(Input, "Input").$$render(
                  $$result,
                  {
                    name: "address",
                    type: "text",
            ...
            {
              default: () => {
                return `<span data-svelte-h="svelte-u6tis7">Academic Level</span> ${validate_component(Input, "Input").$$render(
                  $$result,
                  {
                    name: "academic_level",
                    type: "text",
            ...
            {
              default: () => {
                return `<span data-svelte-h="svelte-8z2i5d">Location</span> ${validate_component(Input, "Input").$$render(
                  $$result,
                  {
                    name: "location",
                    type: "text",
            ...
            {
              default: () => {
                return `<span data-svelte-h="svelte-136j0iw">About Student</span> ${validate_component(Input, "Input").$$render(
                  $$result,
                  {
                    name: "aboutStudent",
                    type: "text",
                    class: "border outline-none",
                    placeholder: "e.g. bonnie@flowbite.com",
                    value: data.aboutStudent
                  },
                  {
                    value: ($$value) => {
                      data.aboutStudent = $$value;
                      $$settled = false;
                    }
                  },
                  {}
            ...
            {
              default: () => {
                return `<span data-svelte-h="svelte-ihgjne">Academic Objective</span> ${validate_component(Input, "Input").$$render(
                  $$result,
                  {
                    ...
                    class: "border outline-none",
                    placeholder: "e.g. bonnie@flowbite.com",
                    value: data.academicObjective
                  },
                  {
                    value: ($$value) => {
                      data.academicObjective = $$value;
                      $$settled = false;
                    }
                  },
                  {}
      ...
      },
      {
        ...
        default: () => {
          return ` <div class="space-y-6 p-0"><form><div class="grid grid-cols-6 gap-6">${validate_component(Label, "Label").$$render(
            ...
            {
              default: () => {
                return `<span data-svelte-h="svelte-1fkf9ez">Avatar</span> <span></span> <div class="pt-5">${validate_component(Button, "Button").$$render($$result, {}, {}, {
                  default: () => {
                    return `${escape(avatar_label)}${validate_component(ChevronDownOutline, "ChevronDownOutline").$$render(
                      $$result,
                      {
                        class: "w-6 h-6 ms-2 text-white dark:text-white"
                      },
                  ...
                  default: () => {
                    return `${each(avatarData, (user) => {
                      return `<p>${escape(user?.name)}</p> ${validate_component(DropdownItem, "DropdownItem").$$render($$result, {}, {}, {
                        default: () => {
                          return `<img width="80px"${add_attribute("src", user?.imageUrl, 0)}${add_attribute("alt", "avatar-" + user?.imagename, 0)} class="text-sm font-normal text-gray-500 dark:text-gray-400">`;
                        }
                      })}`;
                    })}`;
                  }
            ...
            {},
            {
              default: () => {
                return `<span></span> <div class="pt-5">${validate_component(Button, "Button").$$render($$result, {}, {}, {
                  default: () => {
                    return `${escape(student_medium_label)}${validate_component(ChevronDownOutline, "ChevronDownOutline").$$render(
                      $$result,
                      {
                        class: "w-6 h-6 ms-2 text-white dark:text-white"
                      },
      ...
      },
      {
        default: () => {
          return `${validate_component(ExclamationCircleOutline, "ExclamationCircleOutline").$$render(
            ...
            {},
            {}
          )} <h3 class="mb-6 text-center text-lg text-gray-500 dark:text-gray-400" data-svelte-h="svelte-6tiagg">Are you sure you want to delete this Student?</h3> <div class="flex items-center justify-center">${validate_component(Button, "Button").$$render($$result, { color: "red", class: "mr-2" }, {}, {
            default: () => {
              return `Yes, I&#39;m sure`;
            }
    ...
    $$rendered = `${validate_component(MetaTag, "MetaTag").$$render($$result, { path, description, title, subtitle }, {}, {})} <main class="relative h-full w-full overflow-y-auto bg-white dark:bg-gray-800"><div class="p-4">${validate_component(Breadcrumb, "Breadcrumb").$$render($$result, { class: "mb-5" }, {}, {
      ...
      {},
      {
          ...
          return `<div slot="end" class="flex items-center space-x-2">${validate_component(Button, "Button").$$render(
            ...
            {
              default: () => {
                return `${validate_component(PlusOutline, "PlusOutline").$$render($$result, { size: "sm" }, {}, {})}Add students`;
              }
            }
          )} </div>`;
        }
              ...
              return `${validate_component(TableBodyRow, "TableBodyRow").$$render($$result, { class: "text-base" }, {}, {
                default: () => {
                  return ` ${validate_component(TableBodyCell, "TableBodyCell").$$render(
                    ...
                    default: () => {
                      return `${escape(user?.location || "N/A")}`;
                    }
                  })} ${validate_component(TableBodyCell, "TableBodyCell").$$render($$result, { class: "p-4" }, {}, {
                    default: () => {
                    ...
                    default: () => {
                      return `${escape(user?.verificationBadge || "False")}`;
                    }
